  ...
  const options: ApexOptions = {
    ...
    xaxis: {
      ...
      categories: data?.map((data) => {
        if ((data as any)._id === 2) 
          return "Monday";
        else if ((data as any)._id === 3)
          return "Tuesday";
        else if ((data as any)._id === 4)
          return "Wednesday";
        else if ((data as any)._id === 5)
          return "Thursday";
        else if ((data as any)._id === 6)
          return "Friday";
        else if ((data as any)._id === 7)
          return "Saturday";
        else if ((data as any)._id === 1)
          return "Sunday";
      }),
        ...
        <div id="chartTwo" className="-ml-5 -mb-9">
          <ReactApexChart
            ...
            series={[
              {
                name: "Sensor data",
                data: data?.map(data => data.qtd)
              }
               ,
              {
                name: "Notification",
                data: getMatch(data, dataNotification)
              }
            ]}
            type="bar"
            height={350}
